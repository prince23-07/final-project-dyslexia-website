...
const ListeningTest = () => {
  ...
  const playAudio = () => {
    ...
    // In a real app, use Web Speech API for text-to-speech
    ...
    <div className="test-container">
      ...
      {!results && (
        <div className="test-instructions">
          <h3>Instructions:</h3>
          <p>1. Click "Play Audio" to hear the sentence</p>
          <p>2. Type exactly what you hear</p>
          <p>3. Click "Submit" when finished</p>
