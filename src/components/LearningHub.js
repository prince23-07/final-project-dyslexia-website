...
const LearningHub = () => {
  ...
  const playLetterSound = (letter) => {
    const letterData = alphabetData.find(l => l.letter.includes(letter));
    speakText(letter + ' says ' + (letterData ? letterData.sound : ''));
  };
  ...
  return (
    <div className="learning-hub-container">
      <div className="learning-hub-header">
        <h1>📚 Learning Hub</h1>
        <p>Practice letters, sounds, and common words</p>
      </div>

      <div className="learning-hub-tabs">
        <button 
          className={`hub-tab-btn ${activeTab === 'alphabet' ? 'active' : ''}`}
          onClick={() => setActiveTab('alphabet')}
        >
          🔤 Alphabet Sounds
        </button>
        <button 
          className={`hub-tab-btn ${activeTab === 'words' ? 'active' : ''}`}
        ...
        {activeTab === 'alphabet' ? (
          <div className="alphabet-section">
            <div className="section-header">
              ...
              <p className="help-text">Click any letter to hear its sound and see examples</p>
            </div>
          ...
          <div className="words-section">
            <div className="section-header">
              <h2>Common Words</h2>
              <p className="help-text">Click any word to hear it and see examples</p>
            </div>
      ...
      <div className="learning-tips">
        ...
        <div className="tips-grid">
          <div className="tip-card">
            ...
            <p>Listen carefully to each sound and repeat after the audio</p>
          </div>
          <div className="tip-card">
            <span className="tip-icon">📝</span>
            <p>Practice writing letters while saying their sounds</p>
          </div>
          <div className="tip-card">
            <span className="tip-icon">⏰</span>
          ...
          <div className="tip-card">
            <span className="tip-icon">📖</span>
            <p>Use words in sentences to understand their meaning</p>
          </div>
        </div>
      </div>
    </div>
